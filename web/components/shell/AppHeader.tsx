    ...
    <header className="h-14 flex items-center justify-between px-5 border-b border-white/[0.06] bg-[var(--background)] flex-shrink-0">
      <div className="flex items-center gap-6">
        ...
        <nav className="hidden sm:flex items-center gap-1 text-[13px]">
          <NavLink href="/capabilities" active={pathname?.startsWith("/capabilities") ?? false}>
            Capabilities
          </NavLink>
          <NavLink href="/swarm" active={pathname?.startsWith("/swarm") ?? false}>
            Swarm
          </NavLink>
          <NavLink href="/bus" active={pathname?.startsWith("/bus") ?? false}>
            Bus
          </NavLink>
