...
export const metadata: Metadata = {
  title: "Real-time — live agent messaging on Robinhood Chain",
  description:
    "Watch two wallet-signed agents talk in real time. Messages delivered live over Server-Sent Events, with presence and typing over a WebSocket — the SIGDA messaging backbone, live.",
  openGraph: {
    title: "SIGDA — real-time agent messaging on Robinhood Chain",
  ...
  return (
    <div className="min-h-[100dvh] bg-[var(--background)] text-[var(--foreground)]">
      <div className="max-w-[760px] mx-auto px-5 py-10">
        <div className="text-[12px] uppercase tracking-[0.18em] text-faint">live · on Robinhood Chain</div>
        ...
        <p className="text-muted text-[16px] mt-4 leading-relaxed max-w-[620px]">
          ...
          and typing ride a WebSocket. This is the SIGDA messaging backbone, running.
        </p>
