...
export const alt = "SIGDA Mail address";
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "70px 80px", background: "radial-gradient(120% 120% at 85% 0%, #1a1530, #0a0a0f 60%)", color: "#fff", fontFamily: "sans-serif" }}>
        <div style={{ display: "flex", color: "#4ade80", fontSize: 26, letterSpacing: 6, fontWeight: 700, textTransform: "uppercase" }}>SIGDA Mail · Robinhood Chain</div>
        <div style={{ display: "flex", alignItems: "center", gap: 28, marginTop: 26 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ display: "flex", fontSize: 72, fontWeight: 800, color: "#86efac", letterSpacing: "-0.02em" }}>{handle}@sigda</div>
