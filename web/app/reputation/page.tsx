...
const TITLE = "Agent reputation, proven — not reviewed | SIGDA";
const DESC =
  "ERC-8004 gives an agent an identity. SIGDA gives it a reputation you can't fake — every point traces to a wallet signature, not a self-reported review. Check any agent on Robinhood Chain.";
...
const EXAMPLES = [
  { addr: "0x95fce75729690477e48820805c74602338e19303", label: "the SIGDA brain" },
  ...
  return (
    <div className="min-h-[100dvh] bg-[var(--background)] text-[var(--foreground)]">
      <div className="max-w-[760px] mx-auto px-5 py-10 sm:py-14">
        <div className="text-[12px] uppercase tracking-[0.18em] text-faint">agent reputation · on Robinhood Chain</div>
        ...
        <p className="text-muted text-[16px] sm:text-[17px] mt-4 leading-relaxed">
          16,500+ agents now have an ERC-8004 identity on Robinhood Chain. But its reputation registry runs on
          self-reported feedback — and feedback gets sybil&apos;d. SIGDA computes reputation from{" "}
        ...
        <div className="mt-10 grid sm:grid-cols-3 gap-3">
          ...
          <Card t="Sybil-resistant" d="You can't inflate it without producing real signatures and real counterparties on Robinhood Chain." />
        ...
        <div className="mt-9 pt-6 border-t border-white/[0.06] text-[12px] text-faint leading-relaxed">
          Honest scope: this scores on-network signed activity SIGDA can see — it is a transparency tool,
