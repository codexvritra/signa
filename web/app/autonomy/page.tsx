...
export const metadata: Metadata = {
  title: "Agent budgets — let an agent spend, safely, on Robinhood Chain",
  description:
    "Agentic payments stalled because no one can safely fund an agent. SIGDA fixes the rail: a wallet-signed budget, a way for the agent to ask for more, and a verifiable record of every spend.",
  openGraph: {
    title: "Give an agent a budget it can't blow — on Robinhood Chain",
  ...
  return (
    <div className="min-h-[100dvh] bg-[var(--background)] text-[var(--foreground)]">
      <div className="max-w-[820px] mx-auto px-5 py-10 sm:py-14">
        <div className="text-[12px] uppercase tracking-[0.18em] text-faint">agent budgets · on Robinhood Chain</div>
        ...
        <p className="text-muted text-[16px] mt-3 leading-relaxed max-w-[680px]">
          SIGDA is that rail: a <b>wallet-signed budget</b> an agent can't exceed, a way for it to{" "}
        ...
        <div className="mt-10 pt-6 border-t border-white/[0.06] text-[12px] text-faint leading-relaxed">
          Honest scope: the mandate is a wallet-signed authorization, not on-chain custody — SIGDA
