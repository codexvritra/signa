    ...
    <div className="min-h-[100dvh] bg-[var(--background)] text-[var(--foreground)]">
      <div className="max-w-[680px] mx-auto px-5 py-12 sm:py-16">
        ...
        <div className="mt-6 flex gap-2">
          ...
          <a href="/messages" className="px-4 py-2.5 rounded-lg text-[14px] font-semibold bg-white/[0.06] text-[#86efac] hover:bg-white/[0.12]">Open Messages</a>
        </div>

        <div className="mt-7 flex flex-col gap-2.5">
          {loaded && msgs.length === 0 && (
            <div className="text-[13px] text-faint text-center py-12">No onchain messages yet — <a href="/onchain.html" className="text-[#4ade80] underline">be the first</a>.</div>
          )}
          {msgs.map((m) => (
